...
juce::AudioProcessorValueTreeState::ParameterLayout MyEQAudioProcessor::createParameterLayout()
{
    ...
    // these all are the sliders for different EQ settings
    // but what's skew?
    ...
    // parameter choice as in it is a dropdown
    layout.add(std::make_unique<juce::AudioParameterChoice>("LowCut Slope", "LowCut Slope", stringArray, 0));
    // this was 0 instead of 48 in the video so change if it is incorrect
